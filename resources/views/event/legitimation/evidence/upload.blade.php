<x-general-layout>
    ...
    <x-layout.general.breadcrumbs>
        ...
        <x-layout.general.breadcrumb-option name="Subir evidencia" arrow="false" />
    </x-layout.general.breadcrumbs>

    @livewire('event.legitimation.evidence.upload', ['event' => $event->id, 'location' => $location->id ?? 'global'])
</x-general-layout>